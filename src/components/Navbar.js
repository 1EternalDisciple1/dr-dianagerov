            ...
            <nav className="site-header_nav">
              <ul className="site-nav_items row">
                <li className="adaptive_menu_logo order_0">
                  <Link to={"/"} className="adaptive_menu_logo">
                    {/*<Img*/}
                    {/*  fluid={data.logo.edges[0].node.AdaptiveLogo.childImageSharp.fluid}*/}
                    {/*/>*/}
                    <Image
                      image={
                        data.logo.edges[0].node.mobileImage.childImageSharp
                          .fixed
                      }
                      desktopImage={
                        data.logo.edges[0].node.desktopImage.childImageSharp
                          .fixed
                      }
                      alt={data.logo.edges[0].node.alternativeText}
                    />
                    {/* <img
                      className={`lazyload`}
                      data-src={data.logo.edges[0].node.AdaptiveLogo[0].url}
                      alt={
                        data.logo.edges[0].node.AdaptiveLogo[0].alternativeText
                      }
                    /> */}
                  </Link>
                </li>
